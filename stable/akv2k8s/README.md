...
![Version: 2.0.0-beta.57](https://img.shields.io/badge/Version-2.0.0--beta.57-informational?style=flat-square) ![AppVersion: 1.2.0-beta.42](https://img.shields.io/badge/AppVersion-1.2.0--beta.42-informational?style=flat-square)
...
|-----|------|---------|-------| -------------|
| `2.0.0-beta.57` | `1.2.0-beta.xx` | `1.2.0-beta.xx` | Removed | `1.2.0-beta.xx` |
...
```bash
helm repo add spv-charts http://charts.spvapi.no
helm install akv2k8s spv-charts/akv2k8s --version 2.0.0-beta.57
```
...
| env_injector.image.tag | string | `"1.2.0-beta.59"` | Image tag |
