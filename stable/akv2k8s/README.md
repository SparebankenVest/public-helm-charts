...
| ---------------------------------- | ---------- | ------------ | -------------------- | -------------------- |
| `2.1.1` | `1.3.0`    | `1.3.0`      | `removed`            | `1.3.0`              |
| `2.1.0` | `1.3.0`    | `1.3.0`      | `removed`            | `1.3.0`              |
...
```bash
helm repo add spv-charts http://charts.spvapi.no
helm install akv2k8s spv-charts/akv2k8s --version 2.1.0
```
...
| controller.image.tag | string | `"1.3.0"` | Image tag |
...
| env_injector.image.tag | string | `"1.3.0"` | Image tag |
...
| env_injector.envImage.tag | string | `"1.3.0"` | Image tag |
