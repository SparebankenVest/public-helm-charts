...
![Version: 2.7.3](https://img.shields.io/badge/Version-2.7.4-informational?style=flat-square) ![AppVersion: 1.7.4](https://img.shields.io/badge/AppVersion-1.7.5-informational?style=flat-square)
...
| ---------------------------------- | ---------- | ------------ | -------------------- | -------------------- |
| `2.7.4` | `1.7.5`    | `1.7.5`      | `removed`            | `1.7.5`              |
...
| env_injector.envImage.tag | string | `"1.7.3"` | Image tag |
