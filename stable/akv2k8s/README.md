...
![Version: 2.0.2](https://img.shields.io/badge/Version-2.0.2-informational?style=flat-square) ![AppVersion: 1.2.1](https://img.shields.io/badge/AppVersion-1.2.1-informational?style=flat-square)
...
|-----|------|---------|-------| -------------|
| `2.0.2` | `1.2.0` | `1.2.1` | `removed` | `1.2.1` |
...
```bash
helm repo add spv-charts http://charts.spvapi.no
helm install akv2k8s spv-charts/akv2k8s --version 2.0.2
```
...
| controller.image.tag | string | `"1.2.0"` | Image tag |
...
| env_injector.image.tag | string | `"1.2.1"` | Image tag |
...
| env_injector.envImage.tag | string | `"1.2.1"` | Image tag |
