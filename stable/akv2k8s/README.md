...
![Version: 2.3.3](https://img.shields.io/badge/Version-2.3.3-informational?style=flat-square) ![AppVersion: 1.4.0](https://img.shields.io/badge/AppVersion-1.4.0-informational?style=flat-square)
...
| ---------------------------------- | ---------- | ------------ | -------------------- | -------------------- |
| `2.3.3` | `1.4.0`    | `1.4.0`      | `removed`            | `1.4.0`              |
...
```bash
helm repo add spv-charts http://charts.spvapi.no
helm install akv2k8s spv-charts/akv2k8s --version 2.3.3
```
