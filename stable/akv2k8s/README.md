...
![Version: 2.6.0](https://img.shields.io/badge/Version-2.6.0-informational?style=flat-square) ![AppVersion: 1.6.0](https://img.shields.io/badge/AppVersion-1.6.0-informational?style=flat-square)
...
```bash
helm repo add spv-charts http://charts.spvapi.no
helm install akv2k8s spv-charts/akv2k8s --version 2.6.0
```
...
| env_injector.image.tag | string | `"1.6.0"` | Image tag |
...
| env_injector.envImage.tag | string | `"1.6.0"` | Image tag |
